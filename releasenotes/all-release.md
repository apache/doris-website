...
:::tip Latest Release
🎉 Version 4.0.5 is released. Check out the 🔗[Release Notes](../releasenotes/v4.0/release-4.0.5) here. Apache Doris 4.0 takes a major step forward with new AI support (vector search, AI Functions) and better full-text search capabilities. These upgrades help users stay ahead in the AI and agent era, enabling companies to handle everything from traditional BI analysis to AI-driven workloads.
...
- [2026-04-07, Apache Doris 4.0.5 is released](../releasenotes/v4.0/release-4.0.5.md)

- [2026-03-11, Apache Doris 4.0.4 is released](../releasenotes/v4.0/release-4.0.4.md)
