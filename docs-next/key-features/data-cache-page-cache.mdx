...
## What are the Apache Doris Data Cache and Page Cache? {#what}
...
## How do the Apache Doris Data Cache and Page Cache work? {#how}
...
## When should you use the Apache Doris Data Cache and Page Cache? {#when}
...
- [Iceberg](./iceberg): a primary consumer of the page cache — Iceberg scans read remote Parquet over S3-style object storage.
