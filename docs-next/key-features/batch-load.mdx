...
- [Stream Load](./stream-load.mdx): the synchronous HTTP load path for smaller, real-time batches.
- [Group Commit](./group-commit.mdx): server-side merging for the high-frequency small-batch end of the spectrum.
