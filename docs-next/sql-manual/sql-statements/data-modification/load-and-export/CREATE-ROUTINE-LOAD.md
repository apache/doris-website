...
For complete examples covering Kafka CSV/JSON import, SSL authentication, Merge mode, sequence columns, and more, refer to [Routine Load](../../../../data-operate/import/import-way/routine-load-manual.md) in the Data Import guide.