        ...
        <>
            <div className="home-page-hero">
                ...
                <div className="home-page-hero-right">
                    <a className="home-page-hero-button" href="/getting-started/quick-start">
                        <div className="home-page-hero-button-label"><div>Guides</div></div>
                        <div className="home-page-hero-button-title">
                            ...
                            <div style={{ marginBottom: 10 }}>Quick start</div>
                        </div>
                        <div style={{ fontSize: 12 }}>How to install the latest version of Apache Doris and get it running.</div>
                    </a>
                    <a className="home-page-hero-button" href="/install/source-install/compilation-with-docker">
                        <div className="home-page-hero-button-label"><div>Guides</div></div>
                        <div className="home-page-hero-button-title">
                            {/* <div className="home-page-hero-button-icon">
                                <svg width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div style={{ marginBottom: 10 }}>Deployment</div>
                        </div>
                        <div style={{ fontSize: 12 }}>A variety approch of source compilation and cluster deployment to run clusters.</div>
                    </a>
                    <a className="home-page-hero-button" href="/admin-manual/cluster-management/upgrade">
                        <div className="home-page-hero-button-label"><div>Guides</div></div>
                        <div className="home-page-hero-button-title">
                            {/* <div className="home-page-hero-button-icon">
                                <svg width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div style={{ marginBottom: 10 }}>Upgrading cluster</div>
                        </div>
                        <div style={{ fontSize: 12 }}>Doris cluster can be upgraded using the rolling upgrade method.</div>
                    </a>
                    <a className="home-page-hero-button" href="/admin-manual/cluster-management/upgrade">
                        <div className="home-page-hero-button-label"><div>Benchmark</div></div>
                        <div className="home-page-hero-button-title">
                            {/* <div className="home-page-hero-button-icon">
                                <svg width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path className="icon-svg" d="M18.19 11.13l-6.02 8.68c-.13.17-.4.08-.4-.13v-5.73c0-.43-.35-.77-.77-.77H5.97c-.18 0-.28-.2-.18-.35l6.01-8.69c.12-.18.39-.09.39.12V9.98c0 .42.34.76.76.76h5.02c.17 0 .27.19.17.34Zm1.26.87c.8-1.17-.03-2.76-1.45-2.76h-5.03l.76.76V4.277c0-1.73-2.22-2.42-3.2-1.01l-6.02 8.68c-.81 1.16.02 2.75 1.44 2.75h5.02l-.77-.77v5.72c0 1.72 2.21 2.41 3.19 1l6.01-8.69Z"></path>
                            ...
                            <div style={{ marginBottom: 10 }}>Benchmark</div>
                        </div>
                        <div style={{ fontSize: 12 }}>Learn about the advantages of data processing capabilities through SSB, TPC-H, TPC-DS</div>
                    </a>
