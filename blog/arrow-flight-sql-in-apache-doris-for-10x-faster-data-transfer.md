...
Download [Apache Doris 2.1](https://doris.apache.org/download/) and get a taste of 100 times faster data transfer powered by Arrow Flight SQL. If you need assistance, come find us in the [Apache Doris developer and user community](https://doris.apache.org/slack?utm_source=website&utm_medium=content&utm_content=blog_arrow-flight-sql-in-apache-doris-for-10x-faster-data-transf). 
