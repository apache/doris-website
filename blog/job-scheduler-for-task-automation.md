...
Where are we going with the Doris Job Scheduler? The [Apache Doris developer community](https://doris.apache.org/slack?utm_source=website&utm_medium=content&utm_content=blog_job-scheduler-for-task-automation) is looking at:
