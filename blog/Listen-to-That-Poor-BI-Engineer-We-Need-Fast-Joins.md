...
Find the Apache Doris developers on [Slack](https://doris.apache.org/slack?utm_source=website&utm_medium=content&utm_content=blog_listen-to-that-poor-bi-engineer-we-need-fast-joins)
