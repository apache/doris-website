...
Lastly, I would like to share with you something that interested us most when we first talked to the [Apache Doris community](https://doris.apache.org/slack?utm_source=website&utm_medium=content&utm_content=blog_replacing-apache-hive-elasticsearch-and-postgresql-with-apa):
...
Find Apache Doris developers on [Slack](https://doris.apache.org/slack?utm_source=website&utm_medium=content&utm_content=blog_replacing-apache-hive-elasticsearch-and-postgresql-with-apa)
