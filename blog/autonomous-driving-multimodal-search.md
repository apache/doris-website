---
    ...
    'tags': ['Best Practice']
    "image": '/images/blogs/202604_Multimodal_search_horizontal.png'
---
...
> <BlogLink rel="noopener noreferrer" target='_blank' href='https://www.velodb.io/blog/autonomous-driving-company-unified-multimodal-search-on-apache-doris'>An autonomous driving company consolidated fragmented data platforms by adopting Apache Doris as a unified analytics engine, enabling seamless search across text, vectors, labels, and metadata while reducing query times from minutes to seconds. <SeeMore /></BlogLink>