...
export default function Vendors() {
    return (
        ...
        >
            <section className="bg-[#F7FAFC] px-4 lg:px-0 py-[6rem]">
            ...
            <section className="max-w-[960px] px-4 lg:px-0 mx-auto my-8 lg:my-[5.5rem]">
                <div className="lg:flex gap-x-[5rem] py-[2.5rem]">
                    ...
                    <div className="text-[1rem]/[180%] text-[#1D1D1D]">
                        <p className="mb-4">
                            <Link className="underline text-primary font-medium" to="https://www.velodb.io">
                                VeloDB
                            </Link>{' '}
                            ...
                            <Link className="underline text-primary font-medium" to="https://www.velodb.io/cloud">
                                VeloDB Cloud
                            </Link>{' '}
