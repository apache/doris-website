...
import PageBanner, { ButtonProps } from '@site/src/components/PageBanner';
...
import { AchievementBanner } from '@site/src/components/achievement-banner/achievement-banner';
import { CoreCapabilitiesData } from '@site/src/constant/core-capabilities.data';
import { CoreCapabilitiesCard } from '@site/src/components/core-capabilities-card/core-capabilities-card';
import GetStarted from '@site/src/components/get-started/get-started';
import { HomeEventStarIcon } from '@site/src/components/Icons/home-event-star-icon';
import { UserCaseCarousel } from '@site/src/components/user-case-carousel';
                ...
                title={
                    <div>
                        <p>
                            <Translate
                                id="homepage.unified"
                                description="Unified data warehouse for various analytics use cases"
                            >
