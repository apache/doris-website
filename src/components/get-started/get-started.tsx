...
export default function GetStarted() {
    ...
    return (
        <div className="relative overflow-hidden py-[6.8rem] bg-center bg-cover bg-[url(@site/static/images/ecomsystem/download-bg.png)]">
            ...
            <div className="container mx-auto">
                ...
                <div className="relative z-[1] mt-10 flex justify-center space-x-4 lg:space-x-10">
