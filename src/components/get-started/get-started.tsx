...
export default function GetStarted() {
    ...
    return (
        <div className="relative overflow-hidden bg-primary py-[5.5rem] bg-center bg-cover bg-[url(@site/static/images/ecomsystem/download-bg.png)]">
            ...
            <div className="container max-w-[742px] mx-auto">
                <h2 className="text-center text-[1.75rem] leading-normal lg:font-semibold text-white lg:text-[2.75rem]/[4.375rem]">
                    {data.title}
                </h2>
