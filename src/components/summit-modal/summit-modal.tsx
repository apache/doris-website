            ...
            <div style={{fontFamily:'Inter'}}>
                ...
                >
                    <div
                        ...
                        style={{
                            backgroundImage: 'url(/images/summit-bg.png)',
                    ...
                    >
                        <div className="text-[#FFF]">
                            <div className="mb-[1.625rem] text-[1rem] font-medium">Doris Summit 2025</div>
                            <div className="text-[1.75rem]/[120%] font-semibold text-[#F8FAFF]">Call for Speaker !</div>
                        </div>
                    </div>
                </div>
                <div className="rounded-b-lg bg-[#FFF] px-[44px] py-[1.5rem]">
                    ...
                    <p className="mb-3 text-[0.75rem]/[1rem] text-[#616161]">
                        We're excited to invite the global Apache Doris community to share your voice at Doris
                        Summit 2025!
                    </p>
                    <p className="mb-[1.25rem] text-[0.75rem]/[1rem] text-[#616161]">
                        Bring your insights, challenges, and visions to the summit, and inspire the data world with your
                        journey. Together, let's advance the conversation and push the boundaries of what's possible
                        with Apache Doris.
                    </p>
                    <Link
