        ...
        children: [
            {
                label: CPUEnum.X64,
                value: CPUEnum.X64,
                gz: `${ORIGIN}apache-doris-2.0.15-bin-x64.tar.gz`,
                asc: `${ORIGIN}apache-doris-2.0.15-bin-x64.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-2.0.15-bin-x64.tar.gz.sha512`,
            ...
            },
            {
                label: CPUEnum.X64NoAvx2,
                value: CPUEnum.X64NoAvx2,
                gz: `${ORIGIN}apache-doris-2.0.15-bin-x64-noavx2.tar.gz`,
                asc: `${ORIGIN}apache-doris-2.0.15-bin-x64-noavx2.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-2.0.15-bin-x64-noavx2.tar.gz.sha512`,
                source: 'https://downloads.apache.org/doris/2.0/2.0.15/',
                version: '2.0.15',
            },
            {
                label: CPUEnum.ARM64,
                value: CPUEnum.ARM64,
                gz: `${ORIGIN}apache-doris-2.0.15-bin-arm64.tar.gz`,
                asc: `${ORIGIN}apache-doris-2.0.15-bin-arm64.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-2.0.15-bin-arm64.tar.gz.sha512`,
                source: 'https://downloads.apache.org/doris/2.0/2.0.15/',
                version: '2.0.15',
            },
        ],
