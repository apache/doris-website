        ...
        children: [
            {
                label: CPUEnum.X64,
                value: CPUEnum.X64,
                gz: `${ORIGIN}apache-doris-3.0.6.1-bin-x64.tar.gz`,
                asc: `${ORIGIN}apache-doris-3.0.6.1-bin-x64.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-3.0.6.1-bin-x64.tar.gz.sha512`,
                source: 'https://downloads.apache.org/doris/3.0/3.0.6.1/',
                version: '3.0.6.1',
            },
            {
                label: CPUEnum.X64NoAvx2,
                value: CPUEnum.X64NoAvx2,
                gz: `${ORIGIN}apache-doris-3.0.6.1-bin-x64-noavx2.tar.gz`,
                asc: `${ORIGIN}apache-doris-3.0.6.1-bin-x64-noavx2.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-3.0.6.1-bin-x64-noavx2.tar.gz.sha512`,
                source: 'https://downloads.apache.org/doris/3.0/3.0.6.1/',
                version: '3.0.6.1',
            },
            {
                label: CPUEnum.ARM64,
                value: CPUEnum.ARM64,
                gz: `${ORIGIN}apache-doris-3.0.6.1-bin-arm64.tar.gz`,
                asc: `${ORIGIN}apache-doris-3.0.6.1-bin-arm64.tar.gz.asc`,
                sha512: `${ORIGIN}apache-doris-3.0.6.1-bin-arm64.tar.gz.sha512`,
                source: 'https://downloads.apache.org/doris/3.0/3.0.6.1/',
                version: '3.0.6.1',
            },
        ],
