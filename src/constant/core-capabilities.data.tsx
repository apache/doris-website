...
export const CoreCapabilitiesData = [
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                <circle cx="24" cy="24" r="24" fill="var(--brand-primary)" />
                <rect x="17" y="17" width="18" height="18" rx="2" fill="var(--brand-primary-soft)" />
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                <circle cx="24" cy="24" r="24" fill="var(--brand-primary)" />
                <rect x="10" y="13" width="28" height="22" rx="2" fill="var(--brand-primary-soft)" />
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                ...
                <circle cx="18" cy="29" r="7" fill="var(--brand-primary-soft)" />
