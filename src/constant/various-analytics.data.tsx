...
export const VariousAnalyticsData = [
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <circle cx="11.2943" cy="11.294" r="4.70588" fill="#1FCD94" />
                <path
    ...
    },
    {
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <rect x="0.470703" y="5.64697" width="15.0588" height="4.70588" rx="0.941176" fill="#1FCD94" />
                <path
                ...
                <rect x="0.470703" width="15.0588" height="4.70588" rx="0.941176" fill="#1FCD94" />
        ...
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                    ...
                    fill="#C0C3F1"
                />
                <circle cx="8.8001" cy="6.39995" r="5.2" fill="#1FCD94" />
                <path
