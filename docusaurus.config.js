        ...
        [
            '@docusaurus/plugin-client-redirects',
            {
                ...
                redirects: [
                    ...
                    // /docs and /zh-CN/docs land on the default stable version's
                    // entry doc. `lastVersion: '4.x'` makes 4.x the stable version
                    // but its `path: '4.x'` keeps it under /docs/4.x/, so the bare
                    // /docs route has no generated page without this redirect.
                    {
                        from: '/docs',
                    ...
                    { from: '/users',          to: '/why-doris/users' },
                    { from: '/zh-CN/users',    to: '/zh-CN/why-doris/users' },
                    { from: '/download',       to: '/download-next' },
                    { from: '/zh-CN/download', to: '/zh-CN/download-next' },
                    // /ecosystem/* was retired; its closest spiritual home is the
                    // Dev tree's Data Integration intro, which catalogs the same
                    // connector/tool families the old /ecosystem/ pages did.
                    { from: '/ecosystem',                              to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/ecosystem/cluster-management',           to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/ecosystem/connectors',                   to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/ecosystem/data-loading',                 to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/ecosystem/data-migration',               to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/ecosystem/distributions-and-packaging',  to: '/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem',                              to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem/cluster-management',           to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem/connectors',                   to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem/data-loading',                 to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem/data-migration',               to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
                    { from: '/zh-CN/ecosystem/distributions-and-packaging',  to: '/zh-CN/docs/dev/connection-integration/data-integration/intro' },
