...
This document mainly introduces the performance of Doris on the TPC-H SF1000 test set.

On 22 queries on the TPC-H standard test data set, we conducted a comparison test based on Apache Doris.
...
The TPC-H 1000G data generated by the simulation of the entire test are respectively imported into Apache Doris for testing. The following is the relevant description and data volume of the table.
