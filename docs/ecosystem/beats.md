...
[Learn more about Doris Stream Load ](../data-operate/import/stream-load-manual.md)
...
| headers        | Users can pass in [stream-load import parameters](../data-operate/import/stream-load-manual.md) through the headers.             |             |
