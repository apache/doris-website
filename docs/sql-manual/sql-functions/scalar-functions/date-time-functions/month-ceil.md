...
| `<origin>` | The starting time point of the interval. Supports DATE/DATETIME/TIMESTAMP_NS types. Default value is 0001-01-01 00:00:00. |
...
Returns the temporal type selected from the input arguments, representing the time value after rounding up to the nearest specified month interval. The time component is set to 00:00:00, and the day component is set to 01.
