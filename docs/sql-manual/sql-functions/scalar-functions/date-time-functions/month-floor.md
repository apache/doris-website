...
Returns the temporal type selected from the input arguments, representing the time value after rounding down to the nearest specified month interval. The time component is set to 00:00:00, and the day component is set to 01.
