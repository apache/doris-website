...
- `default_llm_resource`: Globally default resource

- `defualt_llm_classify_resource`: Default resource for LLM_CLASSIFY

- `default_llm_extract_resource`: Default resource for LLM_EXTRACT

- `default_llm_fixgrammar_resource`: Default resource for LLM_FIXGRAMMAR

- `default_llm_generate_resource`: Default resource for LLM_GENERATE

- `default_llm_mask_resource`: Default resource for LLM_MASK

- `default_llm_sentiment_resource`: Default resource for LLM_SENTIMENT

- `default_llm_summarize_resource`: Default resource for LLM_SUMMARIZE

- `default_llm_translat_resource`: Default resource for LLM_TRANSLATE
...
2. If not specified, check whether a specific default resource is set for the function
3. The global default resource (`default_llm_resource`)
...
SET default_llm_sentiment_resource='function_default_resource';
SELECT LLM_SENTIMENT('this is a test'); -- Uses resource named 'function_default_resource'
...
2. `LLM_SENTIMENT`
```sql
SET default_llm_sentiment_resource = 'resource_name';
