---
{
    "title": "AES_ENCRYPT",
    "language": "en",
    "description": "AES encryption function. This function behaves the same as the AES_ENCRYPT function in MySQL. The default algorithm is AES_128_ECB,"
}
---
...
2. Then, for the key input by the user, the `i`th byte and the `16*k+i`th byte are XORed. If the key input by the user is less than 16 bytes, 0 is added at the end.
