...
| -- | -- |
| `<expr>` | The expression to get the value. Supported types are String, Date, DateTime, TimestampNs, Timestamptz, IPv4, IPv6, UUID, TinyInt, Bool, SmallInt, Integer, BigInt, LargeInt, Float, Double, Decimal. |
