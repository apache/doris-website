---
{
    "title": "RETENTION",
    "language": "en",
    "description": "The retention function takes as arguments a set of conditions from 1 to 32 arguments of type Bool that indicate whether a certain condition was met "
}
---
