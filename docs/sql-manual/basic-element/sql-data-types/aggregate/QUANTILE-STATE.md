...
QUANTILE_STATE cannot be used as a key column. The columns of the QUANTILE_STATE type can be used in Aggregate tables, Duplicate tables and Unique tables. When used in an Aggregate table, the aggregation type is QUANTILE_UNION when building table.
