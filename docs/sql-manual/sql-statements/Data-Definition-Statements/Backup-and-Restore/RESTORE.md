...
- PROPERTIES currently supports the following properties:
  ...
  - "reserve_storage_policy" = "true": Default is true, The restored table will keep the storage policy as before the backup, and the correspond storage policies will be created. When the reserve_storage_policy is false, the restored tables become normal and will not cooldown.
