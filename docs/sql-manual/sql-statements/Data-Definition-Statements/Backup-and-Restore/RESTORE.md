...
- PROPERTIES currently supports the following properties:
  ...
  - "reserve_colocate" = "true": Default is false. When this property is false, the colocate property is ignored. When this property is true, the restored table reserved colocate property.
