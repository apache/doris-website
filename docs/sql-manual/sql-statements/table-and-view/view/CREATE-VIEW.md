...
This statement is used to create a logical view through a specified query statement.
...
- Views are logical and do not have physical storage. All queries on the view are equivalent to queries on the corresponding subquery of the view.
- Creating and dropping views do not affect the data in the underlying tables.
