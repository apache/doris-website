...
This command is used to show tables and partitions which is using the specific storage policy
...
1. get objects which are using the storage policy named test_storage_policy
