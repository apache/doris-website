...
This command is used to view the execution of the Create Materialized View job submitted through the [CREATE-MATERIALIZED-VIEW](../../sql-statements/Data-Definition-Statements/Create/CREATE-MATERIALIZED-VIEW.md) statement.
