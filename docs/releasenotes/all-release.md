...
:::tip Latest Release
🎉 Version 4.0.5 is released. Check out the 🔗[Release Notes](../releasenotes/v4.0/release-4.0.5) here. Apache Doris 4.0.5 enhances inverted index with BM25 scoring, phrase queries and LDAPS support, plus broad stability fixes.
