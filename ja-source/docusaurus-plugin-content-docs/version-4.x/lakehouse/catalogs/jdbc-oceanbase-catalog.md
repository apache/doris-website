...
* OceanBaseデータベース用のJDBCドライバー。[Maven Repository](https://mvnrepository.com/artifact/com.oceanbase/oceanbase-client)からOceanBase JDBCドライバーをダウンロードできます。OceanBase Connector/J 2.4.8を使用してください。
