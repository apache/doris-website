...
配列の要素にlambda式を適用し、戻り値が0以外の要素数をカウントします。
...
+--------------------------------------------------+
```
ネストされた高階関数の例 - 5より大きい要素を含む配列の数を数える：
