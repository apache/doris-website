...
| CreateTableStmt   | string   | タブレットに対応するTableのTable作成文。この文は元のTable構築文ではなく、後でタブレットをローカルにロードするための簡略化されたTable構築文です。                            |
...
| Privilege  | Object   | 注釈                                                                            |
|:-----------|:---------|:---------------------------------------------------------------------------------|
| Admin_priv | Database | Table、パーティション、およびシステムレベルのコマンドの管理を含む、データベースでの管理操作を実行するために必要です。 |
