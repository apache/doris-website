---
{
  ...
  "language": "ja",
  "description": "各BEノードのデータキャッシュに関するメトリック情報を表示するために使用されます。"
}
---
## 概要

各BEノードでのデータキャッシュに関するメトリック情報を表示するために使用されます。メトリック情報は、BEのデータキャッシュに関連する監視メトリックから取得されます。
