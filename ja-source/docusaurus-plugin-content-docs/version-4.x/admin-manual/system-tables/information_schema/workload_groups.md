...
| SPILL_THRESHOLD_LOW_WATERMARK  | varchar(256) | Workload Groupのディスクスピル低位境界値                     |
| SPILL_THRESHOLD_HIGH_WATERMARK | varchar(256) | Workload Groupのディスクスピル高位境界値                     |
| TAG                            | varchar(256) | Workload Groupのタグ                                         |
| READ_BYTES_PER_SECOND          | bigint       | ローカル読み取りで毎秒スキャンされるバイト数                 |
| REMOTE_READ_BYTES_PER_SECOND   | bigint       | リモート読み取りで毎秒スキャンされるバイト数                 |
