---
{
  ...
  "description": "Apache Doris JDBC カタログは、標準のJDBCインターフェースを介してOracleデータベースへの接続をサポートしています。",
  "language": "ja"
}
---
Apache Doris JDBC カタログは、標準のJDBCインターフェースを介してOracleデータベースへの接続をサポートしています。このドキュメントでは、Oracleデータベース接続の設定方法について説明します。
