---
{
  ...
  "description": "Storage Vaultのミュータブルプロパティを変更します。",
  "language": "ja"
}
---
## 説明

Storage Vaultの変更可能なプロパティを変更します。
...
この SQL コマンドを実行するユーザーは、少なくとも ADMIN_PRIV 権限を持つ必要があります。
