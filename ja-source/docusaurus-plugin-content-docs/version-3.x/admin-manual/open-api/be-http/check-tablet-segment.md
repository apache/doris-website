---
{
  "title": "全タブレットセグメント消失をチェック",
  "language": "ja",
  "description": "BEノードでセグメントが失われる原因となる例外がいくつか発生する可能性があります。しかし、メタデータではタブレットが正常であることが示されています。"
}
---
...
* `repair`
    - `true`: segmentが失われたタブレットはSHUTDOWNステータスに設定され、不良レプリカとして扱われ、FEによって検出および修復できます。
