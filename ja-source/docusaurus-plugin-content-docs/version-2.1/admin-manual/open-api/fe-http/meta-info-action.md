---
{
  ...
  "language": "ja",
  "description": "Meta Info Actionは、クラスター内のメタデータ情報を取得するために使用されます。データベース一覧、テーブル構造などです。",
  "sidebar_label": "Meta Info Action"
}
---
# Meta Action

Meta Info Actionは、クラスター内のメタデータ情報を取得するために使用されます。データベースリスト、テーブル構造などです。
...
指定されたデータベース内のテーブルの一覧をアルファベット順に取得します。
