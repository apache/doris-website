---
{
  "title": "HLL",
  "language": "ja",
  "description": "HLLは近似重複排除に使用され、大容量データを扱う際にCount Distinctよりも優れた性能を発揮します。"
}
---
HLLは近似重複除去に使用され、大量データを扱う際にCount Distinctよりも優れた性能を発揮します。HLLの読み込みは、hll_hashのような関数と組み合わせる必要があります。詳細なドキュメントについては、[HLL](../../../sql-manual/basic-element/sql-data-types/aggregate/HLL)を参照してください。
