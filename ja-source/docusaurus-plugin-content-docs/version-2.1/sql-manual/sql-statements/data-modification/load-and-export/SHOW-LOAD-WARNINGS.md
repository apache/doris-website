---
{
  "title": "LOAD警告を表示",
  "language": "ja",
  "description": "インポートタスクが失敗し、エラーメッセージがETLQUALITYUNSATISFIEDの場合、インポート品質の問題があることを示しています。"
}
---
## 説明
...
- 指定されたデータベースのインポートタスクで品質に問題があるデータを表示します。ラベルは"load_demo_20210112"として指定されています。
