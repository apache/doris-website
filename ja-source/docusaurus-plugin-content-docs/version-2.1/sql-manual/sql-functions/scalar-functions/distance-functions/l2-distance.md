---
{
  "title": "L2_DISTANCE",
  "language": "ja",
  "description": "ユークリッド空間において2点間の距離を計算する（vectorの値は座標）"
}
---
## 説明
...
| `<array2>` | 2番目のベクトル（ベクトル値は座標）、入力配列のサブタイプサポート：TINYINT、SMALLINT、INT、BIGINT、LARGEINT、FLOAT、DOUBLE、要素数はarray1と一致する必要があります |
