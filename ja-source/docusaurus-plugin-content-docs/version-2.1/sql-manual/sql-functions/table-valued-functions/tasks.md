---
{
  "title": "タスク",
  "language": "ja",
  "description": "テーブル関数、タスクの一時テーブルを生成する、"
}
---
## 説明

テーブル関数。タスクの一時テーブルを生成し、現在のDorisクラスター内でジョブによって生成されたタスクの情報を表示することができます。
...
| Field         | Description                                                                                       |
|---------------|---------------------------------------------------------------------------------------------------|
| **`<type>`**  | タスクのタイプ: <br/> `insert`: insert型タスク。 <br/> `mv`: materialized view型タスク。 |


## 戻り値

-  **`tasks("type"="insert")`** insert型のタスク戻り値
...
-  **`tasks("type"="mv")`** MV型のタスク戻り値
   ...
   | **MvDatabaseId**      | materialized viewのデータベースID                                              |
   | **MvDatabaseName**    | materialized viewが属するデータベース名                 |
   | **Status**            | タスクステータス                                                                 |
   | **ErrorMsg**          | タスク失敗情報                                                   |
   | **CreateTime**        | タスク作成時刻                                                          |
   | **StartTime**         | タスク開始実行時刻                                                     |
