...
- SQL サーバー カタログがIDENTITY列情報の識別をサポートするようになりました。[#51285](https://github.com/apache/doris/pull/51285)
- 一部の場合においてJdbc カタログテーブルが行数情報を取得できない問題を修正しました。[#50901](https://github.com/apache/doris/pull/50901)
