---
{
  "title": "リリース 1.1.3",
  "language": "ja",
  "description": "このリリースでは、DorisチームはVersion 1.1.2以降、80以上の問題またはパフォーマンス改善を修正しました。このリリースはVersion 1のバグフィックスリリースです。"
}
---
...
- md5sum()/sm3sum()でbrokerを使用してデータロード時のBEコア。[#13009](https://github.com/apache/doris/pull/13009)

# アップグレード注意事項

PageCacheとChunkAllocatorは、メモリ使用量を削減するためにデフォルトで無効になっており、設定項目`disable_storage_page_cache`と`chunk_reserved_bytes_limit`を変更することで再有効化できます。
