---
{
  "title": "DROP OBSERVER",
  "language": "ja",
  "description": "このステートメントは、FRONTEND の OBSERVER ロールを持つノードを削除します（管理者のみが使用！）"
}
---
## 説明

このステートメントは、FRONTEND の OBSERVER ロールを持つノードを削除します（管理者のみが使用！）
...
1. OBSERVERノードの削除
   ...
   ```
このコマンドは、クラスター内のOBSERVERノードを削除します（IPアドレス host_ip、ポート 9010）
