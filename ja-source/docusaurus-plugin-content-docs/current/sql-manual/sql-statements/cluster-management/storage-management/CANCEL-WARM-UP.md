---
{
  "title": "ウォームアップ キャンセル",
  "language": "ja",
  "description": "Dorisで指定されたウォームアップジョブを終了するために。"
}
---
## 説明

Dorisで指定されたウォームアップジョブを終了するためのものです。
...
> 終了したいwarm-upジョブのidで、`SHOW WARM UP JOB`コマンドで照会できます。
...
`SHOW WARM UP JOB`でシステムで現在実行中のwarm-upジョブを照会します：
