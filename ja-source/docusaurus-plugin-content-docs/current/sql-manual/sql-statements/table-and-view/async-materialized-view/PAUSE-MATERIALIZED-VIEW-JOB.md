---
{
  ...
  "language": "ja",
  "description": "このステートメントは、マテリアライズドビューのスケジュールされたスケジューリングを一時停止するために使用されます"
}
---
## 説明
...
> マテリアライズドビュー名を指定します。
>
> マテリアライズドビュー名は文字で始まる必要があり（unicode名前サポートが有効な場合は任意の言語文字）、スペースや特殊文字を含むことはできません。ただし、マテリアライズドビュー名全体がバッククォートで囲まれている場合は除きます（例：`My Object`）。
>
