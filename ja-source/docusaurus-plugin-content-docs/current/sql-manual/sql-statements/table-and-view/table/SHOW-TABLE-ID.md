---
{
  "title": "SHOW TABLE ID",
  "language": "ja",
  "description": "このステートメントは、テーブルIDに基づいて対応するデータベース名、テーブル名を見つけるために使用されます。"
}
---
### 説明

このステートメントは、テーブルIDに基づいて対応するデータベース名、テーブル名を検索するために使用されます。
...
| カラム名 (Column) | 型 (DataType) | 備考 (Notes) |
|:--------------------|:-------------|:----------|
...
- table idに応じて対応するデータベース名、テーブル名を検索する
