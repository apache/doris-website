...
## 説明
IPv4アドレスとCIDRプレフィックス長に基づいてネットワークセグメントの最小および最大IPv4アドレスを計算し、2つのIPv4アドレスを含む構造体を返します。
...
- 計算はネットワークマスクに基づいており、最小アドレスでは全てのホストビットをゼロに設定し、最大アドレスでは全てのホストビットを1に設定します
