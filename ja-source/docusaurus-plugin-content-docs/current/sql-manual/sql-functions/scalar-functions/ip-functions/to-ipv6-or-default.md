---
{
  ...
  "language": "ja",
  "description": "IPv6アドレスの文字列形式を受け取り、IPv6型の値を返します。無効な入力またはNULL入力の場合は、デフォルト値::を返します。"
}
---
## to_ipv6_or_default
...
```
### パラメータ
- `<ipv6_str>`: 文字列型IPv6アドレス

### 戻り値
戻り値の型: IPv6

戻り値の意味:
- IPv6型の値を返し、そのバイナリ形式は`ipv6_string_to_num`関数の戻り値のバイナリ形式と同じです
