---
{
  ...
  "language": "ja",
  "description": "64ビットMurmurHash3ハッシュ値を計算します。"
}
---
## 説明
...
`MURMUR_HASH3_64`との違いは、このバージョンはMurmurHash3の128ビット処理関数を再利用し、最初の64ビットハッシュ値のみを出力することで、[standard library](https://mmh3.readthedocs.io/en/latest/api.html#mmh3.hash64)実装と一致することです。
