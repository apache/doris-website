---
{
  "title": "SM4_DECRYPT",
  "language": "ja",
  "description": "SM4は国家標準の対称鍵暗号化アルゴリズムで、金融、通信、電子商取引などの分野で広く使用されている。"
}
---
## 説明

SM4は国家標準の対称鍵暗号化アルゴリズムで、金融、通信、電子商取引などの分野で広く使用されています。SM4_DECRYPT関数はSM4を使用してデータを復号化するために使用されます。デフォルトのアルゴリズムは`SM4_128_ECB`です。
