---
{
  "title": "ARRAY_LAST",
  "language": "ja",
  "description": "配列内でラムダ式を満たす最後の要素を見つけます。条件を満たす最後の要素を見つけて返します。"
}
---
## array_last
...
ラムダ式を満たす配列内の最後の要素を検索します。条件を満たす最後の要素を見つけて返します。
...
+-------------------------------------------------------------+
```
マルチ配列検索、1番目の配列が2番目の配列より大きい最後の要素を見つける:
...
+-------------------------------------------------------------------------+
```
ネストされた配列の検索、各サブ配列の長さが2より大きい最後の要素を見つける:
