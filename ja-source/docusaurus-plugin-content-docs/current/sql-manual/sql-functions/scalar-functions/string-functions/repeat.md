...
| `<count>` | 繰り返す回数。非負の整数である必要があります。型: INT |
...
- countが0と等しい場合、空の文字列を返します
- countが0未満の場合、空の文字列を返します
- 結果の文字列が長すぎる場合、文字列長の制限の対象となる可能性があります

特殊なケース:
- いずれかのパラメータがNULLの場合、NULLを返します
- strが空の文字列の場合、countに関係なく空の文字列を返します
- countが0の場合、空の文字列を返します
- countが負の場合、空の文字列を返します
