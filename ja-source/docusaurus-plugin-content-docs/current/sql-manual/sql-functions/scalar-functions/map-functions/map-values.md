---
{
  "title": "MAP_VALUES",
  "language": "ja",
  "description": "指定されたMAPから値を抽出し、対応する型のARRAYに格納します。"
}
---
## 説明

指定された[`MAP`](../../../basic-element/sql-data-types/semi-structured/MAP.md)から値を抽出し、対応する型の[`ARRAY`](../../../basic-element/sql-data-types/semi-structured/ARRAY.md)にします。
