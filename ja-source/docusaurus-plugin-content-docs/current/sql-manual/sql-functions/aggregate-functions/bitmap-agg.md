---
{
  "title": "BITMAP_AGG",
  "language": "ja",
  "description": "入力式のNULL以外の値をBitmapに集約します。値が0未満または18446744073709551615より大きい場合、"
}
---
## 説明

入力式の非NULL値をBitmapに集約します。
...
| 引数 | 説明 |
| -- | -- |
| `<expr>` | 集約される列または式。サポートされる型：TinyInt、SmallInt、Integer、BigInt。 |
