...
この関数は`FROM`句で使用され、Dorisでカタログデータをよりクエリおよび分析しやすくします。
...
|--------------|---------|--------------------------------------------------------------------------------------------------------------------------|
| `CatalogId`  | BIGINT  | 各カタログの一意な識別子です。異なるカタログを区別するために使用されます。                                      |
| `CatalogName`| TEXT    | カタログの名前です。これはDoris内でのカタログの識別子です。                                            |
| `CatalogType`| TEXT    | カタログのタイプ（例：データベース、データソース）です。カタログの種類を示します。                                 |
