...
Aggregate Key Modelテーブルの部分列更新に関する詳細情報（テーブル作成、データ挿入例、使用上の注意事項を含む）については、[Partial Column アップデート](./partial-column-update.md#partial-column-update-for-aggregate-key-model)を参照してください。
