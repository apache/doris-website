---
{
  ...
  "language": "ja",
  "description": "DataX DoriswriterプラグインはMySQL、Oracle、SQL サーバーなどの様々なデータソースからのデータ同期をサポートします。"
}
---
# DataX Doriswriter

[DataX](https://github.com/alibaba/DataX) Doriswriter プラグインは、MySQL、Oracle、SQL サーバー などの様々なデータソースから Stream Load メソッドを使用して Doris にデータを同期することをサポートします。
