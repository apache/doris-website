...
| ---------- | ----------- |-----|-----|
| Resource Group | BEノードレベル、完全なリソース分離、BE障害を分離可能      |   Hard limit  |サポートしません。また、リソースグループ内にデータのコピーを少なくとも1つ保存することを保証する必要があります。    |
| Workload Group | BEプロセス内での分離；BE障害を分離することはできません                                                          | Hard limitとsoft limitの両方    | サポート    |
