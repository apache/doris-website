...
- [Delta Lake](https://doris.apache.org/zh-CN/docs/3.0/lakehouse/catalogs/delta-lake-catalog)
...
:::info 备注
参考文档： [Java UDF - UDTF](https://doris.apache.org/zh-CN/docs/3.0/query-data/udf/java-user-defined-function#java-udtf-实例介绍)
:::
...
[CREATE TABLE AND GENERATED COLUMN](https://doris.apache.org/zh-CN/docs/3.0/sql-manual/sql-statements/table-and-view/table/ALTER-TABLE-ADD-GENERATED-COLUMN)
:::
