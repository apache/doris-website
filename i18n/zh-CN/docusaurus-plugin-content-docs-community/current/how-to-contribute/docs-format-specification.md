...
title: 文档格式规范
language: zh-CN
description: Apache Doris 文档格式规范：文件命名、英文大小写、SQL 函数、缩略语统一约定。
keywords:
    - Apache Doris
    - 文档格式规范
    - 文件命名规则
...
- 不论是历史版本的文档还是最新版本文档，都在 [apache/doris-website](https://github.com/apache/doris-website) 代码库上提交 PR 修改。
- 提交文档修改前，请先阅读 [文档贡献指南](./contribute-doc)。
...
SQL 函数文档排版请参考 [文档贡献指南 - 如何编写命令帮助手册](./contribute-doc#如何编写命令帮助手册)。
...
- 当使用多行代码时，建议**增加代码围栏，指定代码块语言**，从而支持对应语法高亮
...
- 插入图片时**需添加替代文本 Alt**，建议使用 `![Alt 文本描述](https://example.com/your-image.png)`
- 如需图片居中，可使用：
...
在新版文档中，**不建议使用 `>` 引用符号**进行内容描述或嵌套。如需说明备注，可使用注释说明 `:::info :::` 标注。
