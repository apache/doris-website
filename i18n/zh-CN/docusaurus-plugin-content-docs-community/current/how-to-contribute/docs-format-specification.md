...
SQL 函数文档排版请参考文档贡献指南-**[如何编写命令帮助手册](../../current/how-to-contribute/contribute-doc#如何编写命令帮助手册)**
...
- 如需图片居中，可使用 `<div style={{textAlign:'center'}}><img src="图片地址" alt="文本描述" style={{display: 'inline-block'}}/></div >`
...
在新版文档中，**不建议使用 ` > ` 引用符号**进行内容描述或嵌套。如需说明备注，可使用注释说明（参考第六点）`:::note :::` 标注。