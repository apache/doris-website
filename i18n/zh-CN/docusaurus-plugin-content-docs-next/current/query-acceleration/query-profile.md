---
{
    ...
    "sidebar_label": "Query Profile 分析",
    "language": "zh-CN",
...
![Query Profile 整体架构](/images/next/query-acceleration/profile-arch.jpg)
...
![查询计划的三级结构示例](/images/next/query-acceleration/profile-fragment.jpg)
...
![PlanNode 转化为 Pipeline 和 Operator](/images/next/query-acceleration/profile-fragment-2.jpg)
...
![HashJoin 在 Pipeline 中的执行细节](/images/next/query-acceleration/profile-join.jpg)
...
![两阶段聚合的执行细节](/images/next/query-acceleration/profile-agg.jpg)
