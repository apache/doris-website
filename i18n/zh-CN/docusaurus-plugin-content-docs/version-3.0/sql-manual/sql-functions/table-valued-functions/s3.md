...
| compress_type                 | 目前支持 `UNKNOWN/PLAIN/GZ/LZO/BZ2/LZ4FRAME/DEFLATE/SNAPPYBLOCK`，默认值为 `UNKNOWN`，自动推断类型                         |                                                                                  |
...
| jsonpaths                     | 默认为空，适用于 JSON 格式的导入                                                                                               | [JSON Load](../../../data-operate/import/import-way/load-json-format.md)     |
