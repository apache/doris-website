...
- External Catalog
    ...
    可以通过 [CREATE CATALOG](../sql-manual/sql-statements/catalog/CREATE-CATALOG) 命令创建一个 External Catalog。创建后，可以通过 [SHOW CATALOGS](../sql-manual/sql-statements/delete-Show-Statements/SHOW-CATALOGS) 命令查看已创建的 Catalog。
...
- [SHOW CATALOGS 语法帮助](../sql-manual/sql-statements/delete-Show-Statements/SHOW-CATALOGS)
