...
删除 Workload Group 可以参考 [DROP-WORKLOAD-GROUP](../../sql-manual/sql-statements/Data-Definition-Statements/Drop/DROP-WORKLOAD-GROUP);
通过 ALTER-WORKLOAD-GROUP 命令可以调整与修改 Workload Group 配置，参考 [ALTER-WORKLOAD-GROUP](../../sql-manual/sql-statements/Data-Definition-Statements/Alter/ALTER-WORKLOAD-GROUP).
