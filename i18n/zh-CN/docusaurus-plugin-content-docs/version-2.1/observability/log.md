...
更多关于 FE 配置项的信息，可参考 [FE 配置项](../../../../../docs/admin-manual/config/fe-config)。
...
更多关于 BE 配置项的信息，可参考 [BE 配置项](../../../../../docs/admin-manual/config/be-config)。
...
分区按照以下说明配置：
- 使用时间字段上的 [Range 分区](../table-design/data-partitioning/manual-partitioning.md#range-分区) (`PARTITION BY RANGE(`ts`)`)，并开启 [动态分区](../../../../../docs/table-design/data-partitioning/dynamic-partitioning) (`"dynamic_partition.enable" = "true"`)，按天自动管理分区。
...
更多关于分区分桶的信息，可参考 [数据划分](../../../../../docs/table-design/data-partitioning/data-distribution)。
...
更多关于 Logstash 配置和使用的说明，可参考 [Logstash Doris Output Plugin](../../../../../docs/ecosystem/logstash)。
...
更多关于 Filebeat 配置和使用的说明，可参考 [Beats Doris Output Plugin](../../../../../docs/ecosystem/beats)。
