...
:::tip 最新发布
🎉 3.1.0 版本已于 2025 年 09 月 04 日正式发布，详情可查看[版本发布](../releasenotes/v3.1/release-3.1.0)。Apache Doris 3.1 是半结构化分析领域的里程碑，引入了稀疏列和模板化 schema，显著提升了查询和索引性能。它还显著增强了湖仓一体能力，通过异步物化视图和优化连接属性，实现了数据湖和数据仓的无缝集成。新版本在存储引擎上提供了灵活列更新，并通过分区裁剪和基于数据特征的优化器，实现了查询性能的巨大飞跃。
<br />
