...
<details>
    ...
    <Tabs>
        ...
        <TabItem value='GCS' label='GCS'>
            ```sql
            CREATE CATALOG IF NOT EXISTS `iceberg_hms_on_gcs_kerberos_new_catalog` PROPERTIES (
            'type' = 'iceberg',
            'iceberg.catalog.type' = 'hms',
            'hive.metastore.uris' = 'thrift://127.0.0.1:9383',
        ...
        <TabItem value='MinIO' label='MinIO'>
            ```sql
            CREATE CATALOG IF NOT EXISTS test_iceberg_on_hms_minio_catalog PROPERTIES (
            'type' = 'iceberg',
            'iceberg.catalog.type' = 'hms',
