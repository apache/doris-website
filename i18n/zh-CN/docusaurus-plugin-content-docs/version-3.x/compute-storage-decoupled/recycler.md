...
| g_bvar_recycler_instance_last_round_recycle_duration | recycler_instance_last_round_recycle_duration | instance_id | 按实例ID，统计最近一轮回收的总用时 | recycler_instance_last_round_recycle_duration{instance_id="default_instance_id"} 64 |
