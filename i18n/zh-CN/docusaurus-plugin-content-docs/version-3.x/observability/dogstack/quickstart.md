...
![Doris App 插件](/images/observability/dogstack/quickstart_plugin.png)

然后点击 'Enable' 按钮来启用Doris应用程序。

![启用 Doris App](/images/observability/dogstack/quickstart_enable.png)

启用 Doris 应用后，您可以在左侧菜单的“更多应用”下找到它。点击“Doris 应用”，开始探索。

![Doris App 入口](/images/observability/dogstack/quickstart_apps.png)
...
![日志数据源](/images/observability/dogstack/quickstart_logs.png)

您可以尝试在搜索框中输入 'body:error'，以搜索正文字段中包含 'error' 的日志。

![搜索 body:error](/images/observability/dogstack/quickstart_search.png)
...
![Trace 列表](/images/observability/dogstack/quickstart_traces.png)

您可以点击某一特定 Trace 来查看其瀑布流可视化效果。您可以在瀑布流可视化界面中使用“跨度过滤器”进一步筛选该 Trace 中的跨度。

![Trace 瀑布图](/images/observability/dogstack/quickstart_waterfall.png)

## 仪表盘

点击左侧菜单中的 'Dashboards'  ，然后点击 'Doris Demo'。接着点击 'Collector Self-Monitoring'，您将看到下方的演示仪表盘。它展示了OpenTelemetry 采集器自身的主机指标。

![Demo 仪表盘](/images/observability/dogstack/quickstart_dashboard.png)
...
![告警规则](/images/observability/dogstack/quickstart_alert.png)
