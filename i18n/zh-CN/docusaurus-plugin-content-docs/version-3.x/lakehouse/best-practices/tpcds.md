...
Doris 支持通过 [Trino Connector](https://doris.apache.org/community/developer-guide/data-source-extension/trino-connector-developer-guide) 兼容框架，使用 [TPCDS Connector](https://trino.io/docs/current/connector/tpcds.html) 来快速构建 TPCDS 测试集。
