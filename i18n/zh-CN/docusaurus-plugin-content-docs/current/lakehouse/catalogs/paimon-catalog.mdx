...
| varchar                            | string        |                                        |
| char                               | string        |                                        |
| bianry                             | string/varbinary|由properties 中enable.mapping.varbianry(4.0.3后开始支持) 属性控制。默认为 false, 则映射到 string; 为 true 时, 则映射到 varbinary 类型。|
| varbinary                          | string/varbianry| 同上                                  |
| date                               | date          |                                        |
