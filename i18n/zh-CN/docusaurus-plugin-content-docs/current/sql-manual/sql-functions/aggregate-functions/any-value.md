...
| 参数 | 说明 |
| -- | -- |
| `<expr>` | 要聚合的列或表达式，支持类型为 String，Date，DateTime，TimestampNs，Timestamptz，IPv4，IPv6，Bool，TinyInt，SmallInt，Integer，BigInt，LargeInt，Float，Double，Decimal，Array，Map，Struct，AggState，Bitmap，HLL，QuantileState。 |
