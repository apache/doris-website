...
| 参数 | 说明 |
| -- | -- |
| `<expr>` | 用于计算的表达式。支持的类型包括 String、Time、Date、DateTime、TimestampNs、Timestamptz、IPv4、IPv6、UUID、TinyInt、SmallInt、Integer、BigInt、LargeInt、Float、Double、Decimal、Array。 |
