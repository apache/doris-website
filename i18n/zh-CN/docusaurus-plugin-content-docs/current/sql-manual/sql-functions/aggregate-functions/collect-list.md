...
| 参数 | 说明 |
| -- | -- |
| `<expr>` | 确定要放入数组的值的表达式，支持类型为 Bool，TinyInt，SmallInt，Integer，BigInt，LargeInt，Float，Double，Decimal，Date，Datetime，TimestampNs，Timestamptz，IPV4，IPV6、UUID，String，Array，Map，Struct。|
