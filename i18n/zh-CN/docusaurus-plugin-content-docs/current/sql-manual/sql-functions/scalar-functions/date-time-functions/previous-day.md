...
NEXT_DAY 函数用于返回指定日期之前第一个匹配目标星期几的日期，例如 NEXT_DAY('2020-01-31', 'MONDAY') 表示 2020-01-31 前的第一个周一。该函数支持处理 DATE、DATETIME、TIMESTAMP_NS、TIMESTAMPTZ 类型，忽略输入中的时间部分（仅基于日期部分计算）。
