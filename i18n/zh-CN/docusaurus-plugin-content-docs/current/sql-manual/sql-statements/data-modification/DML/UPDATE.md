...
UPDATE 操作目前只支持更新 Value 列，Key 列的更新可参考[使用 FlinkCDC 更新 Key 列](../../../../connection-integration/data-integration/flink-doris-connector/cdc-sync.md#update-key-columns)。
