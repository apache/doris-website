...
该语句用于对已有 table 进行 rollup 进行修改操作。rollup 是异步操作，任务提交成功则返回，之后可使用[SHOW ALTER](/docs/sql-manual/sql-reference/Show-Statements/SHOW-ALTER) 命令查看进度。
...
- 在 properties 中，可以指定存储格式。具体请参阅 [CREATE TABLE](/docs/sql-manual/sql-reference/Data-Definition-Statements/Create/CREATE-TABLE)
