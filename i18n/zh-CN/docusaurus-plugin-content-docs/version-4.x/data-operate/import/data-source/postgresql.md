...
可以通过 Flink Doris Connector 配合 Flink Postgres CDC 实现实时同步，适用于需要在 Flink 中对数据进行额外流式处理的场景。Connector 同时提供一键整库同步工具，更多信息请参考 [Flink Doris Connector](../../../connection-integration/data-integration/flink-doris-connector.md)。
