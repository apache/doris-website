...
| 参数 | 说明 |
| -- | -- |
| `<date_or_time_expr>` | 参数是合法的日期表达式，支持输入 datetime/date/timestamptz 类型,date 类型会转换为对应日期的一天起始时间 00:00:00 ,具体格式请查看 timestamptz的转换, [datetime 的转换](../../../basic-element/sql-data-types/conversion/datetime-conversion) 和 [date 的转换](../../../basic-element/sql-data-types/conversion/date-conversion) |
...
返回 TIMESTAMPTZ, DATETIME 或 DATE 类型的值，表示向下取整后的最近周期时刻。
