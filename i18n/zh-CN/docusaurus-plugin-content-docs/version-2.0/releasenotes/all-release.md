...
🎉 3.0.7 版本已于 2025 年 08 月 25 日正式发布，详情可查看[版本发布](../releasenotes/v3.0/release-3.0.7)。从 3.X 版本开始，Apache Doris 除了支持计算存储一体模式外，还支持计算存储分离模式进行集群部署。借助将计算和存储层解耦的云原生架构，用户可以在多个计算集群之间实现查询负载的物理隔离，以及读写负载的隔离。
