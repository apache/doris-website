        ...
        <div className="home-page-section">
            <div className="home-page-section-left">
                <div className="home-page-option">
                    ...
                    <div style={{ fontWeight: 600, fontSize: 18, marginBottom: 30, marginTop: 12 }}>数据删除</div>
