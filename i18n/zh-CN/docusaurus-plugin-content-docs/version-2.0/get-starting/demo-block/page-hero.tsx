            ...
            <div className="home-page-hero">
                ...
                <div className="home-page-hero-right">
                    <a className="home-page-hero-button" href="../../get-starting/what-is-apache-doris">
                        ...
                        <div style={{ fontSize: 14 }}>了解使用场景、架构与技术特点</div>
                    </a>
                    <a className="home-page-hero-button" href="/docs/en/getting-started/quick-start">
                        ...
                        <div style={{ fontSize: 14 }}>快速安装与使用 Apache Doris</div>
                    </a>
                    <a className="home-page-hero-button" href="https://ask.selectdb.com/">
                        ...
                        <div style={{ fontSize: 14 }}>了解数据模型应对不同业务场景</div>
                    </a>
                </div>
                ...
                <div className="home-page-hero-right">
                    <a className="home-page-hero-button" href="../../get-starting/what-is-apache-doris">
                        ...
                        <div style={{ fontSize: 14 }}>介绍建表和数据划分</div>
                    </a>
                    <a className="home-page-hero-button" href="/docs/en/getting-started/quick-start">
                        <div className="home-page-hero-button-title">
                            <div className="home-page-hero-button-icon">
                        ...
                        <div style={{ fontSize: 14 }}>了解多种数据导入方案</div>
                    </a>
                    <a className="home-page-hero-button" href="https://ask.selectdb.com/">
                        <div className="home-page-hero-button-title">
                            <div className="home-page-hero-button-icon">
                        ...
                        <div style={{ fontSize: 14 }}>滚动升级，无需节点全部停机</div>
                    </a>
                </div>

            </div>
            <div style={{ fontSize: '2rem', fontWeight: 500, width: 600, marginTop: '1.5rem', color: '#1d1d1d' }}>学习路径</div>
        </>
