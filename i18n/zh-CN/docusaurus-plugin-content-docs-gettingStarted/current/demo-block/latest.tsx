                ...
                <div className="home-page-hero-right">
                    <a className="latest-button" href="/getting-started/quick-start">
                        ...
                        <div className="latest-button-title">
                            ...
                            <div style={{ marginBottom: 10 }}>存算分离</div>
                        </div>
                        <div style={{ fontSize: 12 }}>基于云原生存算分离的架构，用户可以通过多计算集群实现查询负载间的物理隔离以及读写负载隔离，并借助对象存储或 HDFS 等低成本的共享存储系统来大幅降低存储成本。</div>
                    </a>
                    <a className="latest-button" href="/getting-started/quick-start">
                        ...
                        <div className="latest-button-title">
                            ...
                            <div style={{ marginBottom: 10 }}>湖仓一体</div>
                        </div>
                        <div style={{ fontSize: 12 }}>3.0 版本是 Apache Doris 在湖仓一体演化路线上的重要里程碑版本。在该版本中 Doris 继续增强数据处理能力，逐步形成基于 Apache Doris 完整湖仓一体解决方案。</div>
                    </a>
