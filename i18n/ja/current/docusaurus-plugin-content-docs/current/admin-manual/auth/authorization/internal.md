---
{
  "title": "ビルトイン認証",
  "language": "ja",
  "description": "認可とは、ユーザーIDがDorisリソースへのアクセスと操作において制限されるメカニズムを指します。"
}
---
## 主要な概念
...
| Node_priv      | Global      | Node変更権限。FE、BE、BROKERノードの追加、削除、廃止を含みます。                                                                                                                              |
...
| Alter_priv     | Global, Catalog, Db, Table | Alter権限。database/tableの名前変更、列の追加/削除/変更、パーティションの追加/削除などを含みます。                                                                                                                  |
| Create_priv    | Global, Catalog, Db, Table | Create権限。catalog、database、table、viewの作成を許可します。                                                                                                                                                 |
| Drop_priv      | Global, Catalog, Db, Table | Drop権限。catalog、database、table、viewの削除を許可します。                                                                                                                                                 |
