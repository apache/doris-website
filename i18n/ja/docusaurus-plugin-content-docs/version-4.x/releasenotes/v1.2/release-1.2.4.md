...
- JDBC CatalogがClickhouseデータソースに接続し、Arrayタイプマッピングをサポート
...
- Hive Catalogの複数の接続問題を修正しました。

- Hudi CatalogのClassNotFound問題を修正しました。

- JDBC Catalogの接続プールを最適化し、接続数の過多を回避しました。
