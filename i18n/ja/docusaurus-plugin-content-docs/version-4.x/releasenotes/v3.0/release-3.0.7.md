...
- DDL操作をサポートしないCatalogのエラーメッセージを最適化しました
...
- マルチCatalogシナリオでの潜在的デッドロック問題を修正しました
- 一部のケースで同時Catalogリフレッシュによって引き起こされるメタデータ不整合問題を修正しました
- 一部のケースでORCフッターが複数回読み取られる問題を修正しました
- Table Valued Functionで圧縮されたjsonファイルを読み取れない問題を修正しました
- SQL Server CatalogでIDENTITY列情報の識別をサポートしました
