---
{
  "title": "ELT",
  "language": "ja",
  "description": "ELT関数は、指定されたインデックス位置の文字列を返します。インデックスのカウントは1から始まります。"
}
---
## 説明

ELT関数は、指定されたインデックス位置にある文字列を返します。インデックスのカウントは1から始まります。
...
VARCHAR型を返します。指定されたインデックス位置の文字列を表します。

特別なケース：
- `<pos>`が1未満または文字列数より大きい場合、NULLを返します
- `<pos>`がNULLの場合、NULLを返します
- インデックスは1から始まり、最初の文字列のインデックスは1です
