---
{
  "title": "マスク",
  "language": "ja",
  "description": "MASK関数は機密情報を保護するためにデータをマスクするために使用されます。デフォルトの動作は大文字をXに変換することです。"
}
---
## 説明
...
VARCHAR型を返し、文字と数字が置き換えられた文字列です。

特殊ケース:
- いずれかのパラメータがNULLの場合、NULLを返します
- 英数字以外の文字は変更されません
- 置き換え文字パラメータが複数文字を含む場合、最初の文字のみが使用されます

## 例

1. 基本的な使用方法: デフォルトの置き換えルール
