...
この関数は、MySQL の [GET_FORMAT function](https://dev.mysql.com/doc/refman/8.4/en/date-and-time-functions.html#function_get-format) と同じ動作をします。
...
第2引数が `'USA', 'JIS', 'ISO', 'EUR', 'INTERNAL'` のいずれでもない場合やNULLの場合、この関数はNULLを返します。
