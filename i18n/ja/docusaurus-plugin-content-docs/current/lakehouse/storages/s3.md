---
{
  "title": "S3 | ストレージ",
  "language": "ja",
  "description": "この文書では、AWS S3にアクセスするために必要なパラメータについて説明します。これらのパラメータは以下に適用されます：",
  "sidebar_label": "S3"
}
---
# S3
...
| s3.connection.maximum        |             | 高同時実行シナリオでの最大接続数                  | 50      | No       |
...
利用可能なその他のリージョンについては、[AWS公式ドキュメント](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-express-Regions-and-Zones.html)を参照してください。
