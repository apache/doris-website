...
Hive に加えて、多くの他のシステムが Hive Metastore を使用してメタデータを格納しています。そのため、Hive Catalog を通じて、Hive テーブルだけでなく、Iceberg や Hudi など、メタデータストレージに Hive Metastore を使用する他のテーブル形式にもアクセスできます。
