---
{
  "title": "Iceberg カタログ",
  "language": "ja",
  "description": "Apache Doris Iceberg Catalog: HMS、Glue、REST、またはJDBC経由でIcebergテーブルに接続。HDFS/クラウドストレージ上のデータをtime travel、スキーマ進化、DDL操作、およびテーブル最適化機能でクエリおよび書き込み。"
}
---
...
:::tip
ユーザーはHive Catalogを通じてHive Metastoreをメタデータとして使用してIcebergテーブルにアクセスできます。ただし、互換性の問題を回避するために、Iceberg Catalogを直接使用することを推奨します。
:::
