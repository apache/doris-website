...
この記事では、可観測性の中核データの一つであるTraceのストレージと分析プラクティスについて紹介します。完全な可観測性ソリューションの概要については、[Overview](./overview.mdx)を参照してください。リソース評価、クラスターのデプロイメント、および最適化については、[Log](./log.md)を参照してください。
