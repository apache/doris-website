...
---
コミュニティユーザーと開発者の皆様のおかげで、Doris 2.0.14バージョンでは約110の改善とバグ修正が行われました。
...
- sequenceカラムを持つMOW tablesのprimary keyポイントクエリパフォーマンスを最適化 [#38287](https://github.com/apache/doris/pull/38287)
...
- 簡素化されたSQL hintsをサポート、例: `SELECT /*+ query_timeout(3000) */ * FROM t;` [#37720](https://github.com/apache/doris/pull/37720)

- `429`エラーに遭遇した際にobject storageからの読み取りを自動的に再試行し、安定性を向上 [#35396](https://github.com/apache/doris/pull/35396)

- LEFT SEMI / ANTI JOINで条件に合致するデータ行にマッチした際に後続のマッチング実行を終了し、パフォーマンスを向上。 [#34703](https://github.com/apache/doris/pull/34703)

- MySQL結果に不正なデータを返す際のcoredumpを防止。 [#28069](https://github.com/apache/doris/pull/28069)

- 型名の出力を小文字で統一し、MySQLとの互換性を維持し、BIツールにより親和的に。 [#38521](https://github.com/apache/doris/pull/38521)


完全なリストはGitHubの[link](https://github.com/apache/doris/compare/2.0.13...2.0.14)からアクセス可能で、主要な機能と改善は以下にハイライトされています。
