---
{
  "title": "WIDTH_BUCKET",
  "language": "ja",
  "description": "等幅ヒストグラムを構築します。ここで、ヒストグラムの範囲は等しいサイズの区間に分割され、計算後、"
}
---
## 説明

等幅ヒストグラムを構築します。ヒストグラムの範囲が等しいサイズの区間に分割され、計算後、式の値が該当するバケット番号を返します。特殊なケース：

- この関数は整数値またはNULL を返します（いずれかの入力がNULLの場合、NULLを返します）
