---
{
  "title": "FIRST_VALUE",
  "language": "ja",
  "description": "FIRSTVALUE()は、ウィンドウパーティション内の順序付けられた値のセットから最初の値を返すwindow関数です。"
}
---
## 説明

FIRST_VALUE()は、ウィンドウパーティション内の順序付けられた値の集合から最初の値を返すウィンドウ関数です。null値の処理は、IGNORE NULLSオプションを使用して制御できます。
