...
- **コンピュート・ストレージ分離シナリオにおいて、Auto Bucketサイズをバケット当たり10GBに調整** [#50566](https://github.com/apache/doris/pull/50566)
...
- Hive Catalogにパーティションキャッシュ TTL制御（`partition.cache.ttl-second`）を追加 [#50724](https://github.com/apache/doris/pull/50724)
...
- **カタログ修正**
  ...
  - Trino Catalogで`information_schema`システムテーブルを有効化 [#49912](https://github.com/apache/doris/pull/49912)
- **ファイル形式**
