...
- Hive Catalogに`hive.recursive_directories_table`と`hive.ignore_absent_partitions`プロパティが追加され、データディレクトリを再帰的にトラバースするかどうか、および存在しないパーティションを無視するかどうかを指定できます。[#39494](https://github.com/apache/doris/pull/39494)
- リフレッシュ中の大量の接続生成を避けるため、Catalogリフレッシュロジックが最適化されました。[#39205](https://github.com/apache/doris/pull/39205)
...
- MaxCompute Catalogが複雑なデータ型をサポートしました。[#39259](https://github.com/apache/doris/pull/39259)
...
- Auto Partitionでの同時オープンの問題が修正されました。[#38605](https://github.com/apache/doris/pull/38605)
