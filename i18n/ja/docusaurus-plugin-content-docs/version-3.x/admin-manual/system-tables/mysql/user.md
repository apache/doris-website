...
| カラム名                               | 型             | 説明                                                |
| -------------------------------------- | -------------- | --------------------------------------------------- |
| host                                   | character(255) | ユーザーの接続が許可されるホスト。                  |
| user                                   | char(32)       | ユーザー名。                                        |
| node_priv                              | char(1)        | ユーザーがNode権限を持つかどうか。                  |
| admin_priv                             | char(1)        | ユーザーがAdmin権限を持つかどうか。                 |
| grant_priv                             | char(1)        | ユーザーがGrant権限を持つかどうか。                 |
| select_priv                            | char(1)        | ユーザーがSelect権限を持つかどうか。                |
| load_priv                              | char(1)        | ユーザーがLoad権限を持つかどうか。                  |
| alter_priv                             | char(1)        | ユーザーがAlter権限を持つかどうか。                 |
| create_priv                            | char(1)        | ユーザーがCreate権限を持つかどうか。                |
