---
{
    "title": "[Doris 发版通告] Apache Doris 1.1 Release 版本正式发布",
    "description": "[Doris 发版通告]Apache Doris 1.1 Release 版本正式发布",
    "date": "2022-07-14",
    "metaTitle": "Apache Doris 1.1 Release 版本正式发布",
    "isArticle": true,
    "language": "zh-CN",
    "author": "鲁志敬",
    "layout": "Article",
...
GitHub地址：[https://github.com/apache/doris](https://github.com/apache/doris)

下载地址：[https://doris.apache.org/downloads/downloads.html](https://doris.apache.org/downloads/downloads.html)

源码地址：[https://github.com/apache/doris/releases/tag/1.1.0-rc05](https://github.com/apache/doris/releases/tag/1.1.0-rc05)
...
[https://doris.apache.org/zh-CN/docs/admin-manual/cluster-management/upgrade.html](https://doris.apache.org/zh-CN/docs/admin-manual/cluster-management/upgrade.html)
...
### 增加ZSTD压缩算法 [#8923](https://github.com/apache/doris/pull/8923) [#9747](https://github.com/apache/doris/pull/9747)
...
-   CPU资源消耗显著降低：针对小文件 Compaction 进行了策略优化，在上述高并发写入场景下，**CPU 资源消耗降低 25%** ；
...
[http://doris.apache.org/zh-CN/downloads/downloads.html](http://doris.apache.org/zh-CN/downloads/downloads.html)
...
[http://doris.apache.org/zh-CN/installing/upgrade.html](http://doris.apache.org/zh-CN/installing/upgrade.html)
