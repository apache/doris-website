...
:::tip Tip
This guide may change as community processes evolve. Join the [Apache Doris Slack community](https://doris.apache.org/slack?utm_source=website&utm_medium=docs&utm_content=contribute_guide) for the latest updates.
:::
