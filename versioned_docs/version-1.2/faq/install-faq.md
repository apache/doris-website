...
3. Manually migrate data using the API
   ...
   Doris provides [HTTP API](../admin-manual/open-api/be-http/tablet-migration), which can manually specify the migration of data shards on one disk to another disk.
