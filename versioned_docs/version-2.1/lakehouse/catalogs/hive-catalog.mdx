---
{
    "title": "Hive Catalog",
    "language": "en",
    "description": "Hive Catalog in Apache Doris 2.1 connects to Hive Metastore and compatible services to query and write Hive, Iceberg and Hudi tables across HDFS and object storage, with configuration guides, supported services, formats and examples."
}
---
