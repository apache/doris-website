---
{
    ...
    "language": "en",
    "description": "Paimon Catalog in Apache Doris 2.1 connects to multiple Paimon metadata services to query Paimon tables across HDFS and cloud object storage, with detailed configuration, properties and query operations, and planned support for writes."
}
---
