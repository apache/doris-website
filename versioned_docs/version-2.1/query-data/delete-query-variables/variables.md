...
* `time_zone`
    ...
    Used to set the time zone for the current session. Defaults to the value of `system_time_zone`. It affects the results of certain time functions. For more information, see the [time zone](../../admin-manual/cluster-management/time-zone.md) documentation.
...
:::tip Tips
This feature is supported since the Apache Doris 2.1 version
:::
...
:::tip Tips
This feature is supported since the Apache Doris 2.0.2 version
:::
