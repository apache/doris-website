...
For more details on creating users, setting passwords, and granting permissions, refer to the [CREATE-USER](../../../sql-manual/sql-statements/account-management/CREATE-USER.md) section.
