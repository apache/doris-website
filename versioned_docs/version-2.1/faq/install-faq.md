...
3. Manually migrate data using the API
   ...
   Doris provides [HTTP API](https://doris.apache.org/docs/dev/admin-manual/be/tablet-migration), which can manually specify the migration of data shards on one disk to another disk.
