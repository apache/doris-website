...
**For expansion and scaling of BE nodes in multi-tenant deployment environments, please refer to the [Multi-tenant Design Document](../../../version-3.0/admin-manual/workload-management/resource-group).**
