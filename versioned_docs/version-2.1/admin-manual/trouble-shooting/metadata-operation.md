...
The deployment recommendation of FE is described in the Installation and [Deployment Document](../../install/deploy-manually/integrated-storage-compute-deploy-manually). Here are some supplements.
