                ...
                <div className="home-page-hero-right">
                    <a className="latest-button" href={`/docs${currentVersion === '' ? '' : `/${currentVersion}`}/gettingStarted/tutorials/building-lakehouse/doris-hudi`}>
                        ...
                        <svg width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div style={{ marginBottom: 10 }}>Building lakehouse using Doris and Hudi</div>
                        </div>
                    ...
                    <a className="latest-button" href={`/docs${currentVersion === '' ? '' : `/${currentVersion}`}/gettingStarted/tutorials/building-lakehouse/doris-paimon`}>
                        ...
                        <svg width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div style={{ marginBottom: 10 }}>Building lakehouse using Doris and Paimon</div>
                        </div>
                        <div style={{ fontSize: 12, marginBottom: 20 }}>How to quickly set up a test & demo environment for Apache Doris and Paimon and how to use.</div>
                    </a>
                </div>
