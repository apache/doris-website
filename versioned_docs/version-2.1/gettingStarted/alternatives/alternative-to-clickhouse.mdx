...
<table border="1">
    ...
    <tr>
        ...
        <td><ul><li style={{fontSize:'14px'}}>Features a strongly consistent primary key storage model, supporting synchronous data updates and deletions</li></ul></td>
        <td><ul><li style={{fontSize:'14px'}}>Only supports asynchronous updates, allowing old values to be read after an update.</li></ul></td>
    </tr>
    <tr>
