...
If the target table of the INSERT OVERWRITE is an autopartitioned table, the behaviour is controlled by the [Session Variable](../../../../query/query-variables/variables#variable)  `enable_auto_create_when_overwrite` controls the behaviour as follows:
