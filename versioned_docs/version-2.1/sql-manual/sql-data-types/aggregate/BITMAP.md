...
You can set the [session variable](../../sql-statements/session/variables/SET-VARIABLE) `return_object_data_as_binary` to `true`. Consequently, the bitmap will be returned in binary format.
