...
Returns an array containing n repeated elements of element. array_repeat has the same function as array_with_constant and is used to be compatible with the hive syntax format.
