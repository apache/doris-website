...
S3(
    ...
    "format" = "<format>"
    [, <use_path_style>, <force_parsing_by_standard_uri>, <column_separator>, <line_delimiter>, <compress_type>, <read_json_by_line>, <strip_outer_array>, <json_root>, <jsonpaths>, <num_as_string>, <fuzzy_parse>, <trim_double_quotes>, <skip_lines>, <path_partition_keys>, <resource>]
  )
```
...
| compress_type                    | Currently supports `UNKNOWN/PLAIN/GZ/LZO/BZ2/LZ4FRAME/DEFLATE/SNAPPYBLOCK`, default value is `UNKNOWN`, automatically inferred type. |                                                                                   |
| read_json_by_line                | Default is `"true"`, used for importing JSON format.                                                                              | [JSON Load](../../../data-operate/import/import-way/load-json-format.md) |
