---
{
    ...
    "language": "en",
    "description": "Describes FE, Catalog, and cache-entry memory limits for external metadata caches in Doris 4.1.4, including Hive, Iceberg, and Paimon configuration."
}
---
