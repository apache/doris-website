...
| s3.credentials_provider_type | glue.credentials_provider_type| Credentials provider type for AWS authentication (used without AK/SK; used as STS source credentials in IAM Role mode) | DEFAULT | No       |
