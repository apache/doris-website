...
| minio.connection.request.timeout | s3.connection.request.timeout | S3 request timeout, in milliseconds, specifies the request timeout when connecting to MinIO service | 3000          | No       |
