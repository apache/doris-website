---
{
    ...
    "language": "en",
    "description": "Paimon Catalog in Apache Doris 4.x connects to multiple Paimon metadata services to query Paimon tables across HDFS and cloud object storage, with detailed configuration, properties and query operations, and planned support for writes."
}
---
