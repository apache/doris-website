...
Use the `$snapshots` system table to query the snapshot information of the table (before version 4.1.4, the `iceberg_meta()` table function could also be used; it has been removed since version 4.1.4):

```
mysql> select * from iceberg.nyc.taxis$snapshots;
+---------------------+---------------------+---------------------+-----------+-----------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
