...
For larger-scale results (10M/100M-level datasets) in single-node and distributed setups, see [Large-scale Performance Benchmark](./performance-large-scale.md).
