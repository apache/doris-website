...
| ---------------------| ----------- |
| `<date_or_time_expr>`| A valid date expression. Supports input of timestamptz/datetime/date/time types. If the type is date, it will be converted to the start time of the day (00:00:00). For specific formats, see timestamptz conversion, [datetime conversion](../../../basic-element/sql-data-types/conversion/datetime-conversion) and [time conversion](../../../basic-element/sql-data-types/conversion/time-conversion). |
