...
|--------------|-------------------------------------------------------------------------------------------------|
| `<datetime_like_type>` | The input datetime value, of type `DATETIME` or `TIMESTAMPTZ`. For specific formats, see timestamptz conversion, [datetime conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/datetime-conversion). |
