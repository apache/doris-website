...
| --------- | ----------- |
| `<datetime>` | The datetime value to be rounded down. Supports input of date/datetime/timestamptz types. For specific formats please see timestamptz的转换, [datetime conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/datetime-conversion) and [date conversion](../../../../sql-manual/basic-element/sql-data-types/conversion/date-conversion). |
