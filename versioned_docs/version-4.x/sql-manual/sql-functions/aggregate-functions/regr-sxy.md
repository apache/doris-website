---
{
    "title": "REGR_SXY",
    "language": "en",
    "description": "Returns the sum of products of the independent variable (x) and the dependent variable (y) for non-null pairs in a group."
}
---
...
Returns a Double value representing the sum of the products of the deviations of `x` and `y` from their respective means.
