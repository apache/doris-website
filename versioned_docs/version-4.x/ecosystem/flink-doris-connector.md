...
| 26.0.0            | 1.15 - 1.20,2.0 - 2.2     | 1.0+          | 8(x),17(2.x) | -             |
...
| --sink-conf             | All the configurations of the Doris Sink can be viewed [here](./flink-doris-connector.md#general-configuration-items). |
