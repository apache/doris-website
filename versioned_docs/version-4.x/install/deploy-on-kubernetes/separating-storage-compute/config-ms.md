...
To locate the ConfigMap generated by `fdb-kubernetes-operator`, see [Get the ConfigMap that contains FoundationDB access information](install-fdb.md#获取包含-foundationdb-访问信息的-configmap) in the FoundationDB deployment chapter.
