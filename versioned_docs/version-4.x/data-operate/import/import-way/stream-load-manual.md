...
| timezone                     | Used to specify the timezone for this import; defaults to the current cluster time zone. This parameter affects the results of all timezone-related functions in the import process. For example, to specify the import timezone as Africa/Abidjan, use the command `-H "timezone:Africa/Abidjan"`. |
