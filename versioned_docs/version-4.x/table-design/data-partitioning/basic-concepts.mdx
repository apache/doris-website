...
Unlike partitions, which split by column value, bucketing spreads data **evenly** across buckets. This reduces skew and improves query performance through better data locality.
