...
## Why use the Apache Doris MCP Server? {#why}
...
## What is the Apache Doris MCP Server? {#what}
...
## How does the Apache Doris MCP Server work? {#how}
...
## When should you use the Apache Doris MCP Server? {#when}
...
- [Model Context Protocol specification](https://modelcontextprotocol.io/specification/2025-11-25): the protocol Apache Doris speaks, including transport details and security guidance.
