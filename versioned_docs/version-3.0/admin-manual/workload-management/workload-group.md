...
```
You can refer to [CREATE-WORKLOAD-GROUP](../../../../docs/sql-manual/sql-statements/cluster-management/compute-management/CREATE-WORKLOAD-GROUP)。
...
```
More details can be found in [SHOW-WORKLOAD-GROUPS](../../../../docs/sql-manual/sql-statements/cluster-management/compute-management/SHOW-WORKLOAD-GROUPS)
...
More details can be found in [ALTER-WORKLOAD-GROUP](../../../../docs/sql-manual/sql-statements/cluster-management/compute-management/ALTER-WORKLOAD-GROUP)
...
More details can be found in[DROP-WORKLOAD-GROUP](../../../../docs/sql-manual/sql-statements/cluster-management/compute-management/DROP-WORKLOAD-GROUP)
