...
Users can create an External Catalog using the [CREATE CATALOG](../sql-manual/sql-statements/catalog/CREATE-CATALOG/) command, and view the existing Catalogs via the [SHOW CATALOGS](../sql-manual/sql-statements/delete-Show-Statements/SHOW-CATALOGS/) command.
...
- [SHOW CATALOGS](../sql-manual/sql-statements/delete-Show-Statements/SHOW-CATALOGS/)
