...
| SyncWithBaseTables     | BOOLEAN | Whether the data is synchronized with the base table. To check which partition is not synchronized, use [SHOW PARTITIONS](../../../../../docs/sql-manual/sql-statements/table-and-view/table/SHOW-PARTITIONS) |
