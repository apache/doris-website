...
| -- | -- | 
| `<dt>` | The value to be converted, which is of `datetime` or `date` type and `string` types that conform to the format, with a maximum precision of six decimal places for seconds (e.g.,2022-12-28 23:59:59.999999),for specific datetime formats, please refer to [cast to datetime](../../../../../../docs/sql-manual/basic-element/sql-data-types/conversion/datetime-conversion) and [cast to date](../../../../../../docs/sql-manual/basic-element/sql-data-types/conversion/datetime-conversion)) |
...
- input is date type,time part will set 00:00:00
## Example
