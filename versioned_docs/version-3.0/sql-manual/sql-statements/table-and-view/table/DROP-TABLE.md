...
- After executing `DROP TABLE` for a period of time, the deleted table can be restored by using the RECOVER statement. For details, see the [RECOVER](../../../../../../docs/sql-manual/sql-statements/recycle/RECOVER) statement.
