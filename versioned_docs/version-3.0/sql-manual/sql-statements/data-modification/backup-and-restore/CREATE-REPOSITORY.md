...
- Any user can view the repositories that have been created by using the [SHOW REPOSITORIES](../../../../../../docs/sql-manual/sql-statements/data-modification/backup-and-restore/SHOW-REPOSITORIES) command.
