...
For the detailed introduction of the `EXPORT` command, please refer to: [EXPORT](../../../../docs/sql-manual/sql-statements/data-modification/load-and-export/EXPORT)
...
After submitting a job, you can query the status of the export job via the [SHOW EXPORT](../../../../docs/sql-manual/sql-statements/data-modification/load-and-export/SHOW-EXPORT) command. An example of the result is as follows: 
...
For the detailed usage of the `show export` command and the meaning of each column in the returned results, please refer to [SHOW EXPORT](../../../../docs/sql-manual/sql-statements/data-modification/load-and-export/SHOW-EXPORT).

### Cancel Export Jobs

After submitting an Export job, the export job can be cancelled via the [CANCEL EXPORT](../../../../docs/sql-manual/sql-statements/data-modification/load-and-export/CANCEL-EXPORT) command before the Export task succeeds or fails. An example of the cancellation command is as follows: 
