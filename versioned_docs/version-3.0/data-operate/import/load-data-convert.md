...
Column mapping implementation can be divided into two core steps:
...
![](/static/images/load-data-convert-csv-en.png)

#### Load JSON Format Data with Specified jsonpaths

![](/static/images/load-data-convert-json1-en.png)

#### Load JSON Format Data without Specified jsonpaths

![](/static/images/load-data-convert-json2-en.png)
