...
2. Create S3 Storage Vault
   ...
   To create a Storage Vault on other object storage, please refer to [Create Storage Vault](../../../../docs/sql-manual/sql-statements/cluster-management/storage-management/CREATE-STORAGE-VAULT).
