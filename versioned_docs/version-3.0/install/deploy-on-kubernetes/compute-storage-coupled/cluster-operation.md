...
Access Doris through `mysql-client` through the method provided in the [Access Doris Cluster](../../../../../docs/install/deploy-on-kubernetes/compute-storage-coupled/install-config-cluster) document.
