...
For more details, refer to [CREATE ASYNC MATERIALIZED VIEW](../../../../../docs/sql-manual/sql-statements/table-and-view/async-materialized-view/CREATE-ASYNC-MATERIALIZED-VIEW).
