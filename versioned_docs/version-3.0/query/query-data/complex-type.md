...
To check the support for Map functions, you can refer to the SQL manual docs under the section for the [MAP](../../sql-manual/sql-statements/Data-Types/MAP) data type.
