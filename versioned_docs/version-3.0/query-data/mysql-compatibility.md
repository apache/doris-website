...
- **Agg_State**
  ...
  AGG_STATE can only be used in combination with [STATE](../../../docs/sql-manual/sql-functions/combinators/state) / [MERGE](../../../docs/sql-manual/sql-functions/combinators/merge)/ [UNION](../../../docs/sql-manual/sql-functions/combinators/union) functions from the SQL manual for aggregators.
