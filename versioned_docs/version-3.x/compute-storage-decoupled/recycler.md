...
| g_bvar_recycler_instance_last_round_recycle_duration | recycler_instance_last_round_recycle_duration | instance_id | Records total duration of the last recycling round by instance ID | recycler_instance_last_round_recycle_duration{instance_id="default_instance_id"} 64 |
