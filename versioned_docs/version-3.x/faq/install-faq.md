...
### Q14. After upgrading to version 1.2, BE fails to start with NoClassDefFoundError issue
...
### Q15. After upgrading to version 1.2, BE startup shows Failed to initialize JNI issue
