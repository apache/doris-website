...
The deployment recommendation of FE is described in the Installation and [Deployment Document](../../../../docs/install/deploy-manually/integrated-storage-compute-deploy-manually). Here are some supplements.
