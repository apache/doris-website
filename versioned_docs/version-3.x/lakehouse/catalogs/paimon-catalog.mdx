---
{
    ...
    "language": "en",
    "description": "Paimon Catalog in Apache Doris 3.x connects to multiple Paimon metadata services to query Paimon tables across HDFS and cloud object storage, with detailed configuration, properties and query operations, and planned support for writes."
}
---
