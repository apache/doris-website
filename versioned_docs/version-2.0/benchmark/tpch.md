...
Please refer to the [official document](../install/cluster-deployment/standard-deployment) to install and deploy Doris to obtain a normal running Doris cluster (at least 1 FE 1 BE, 1 FE 3 BE is recommended).
