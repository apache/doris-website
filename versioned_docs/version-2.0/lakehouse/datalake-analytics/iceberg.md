...
In addition, you can use the [iceberg_meta](../../sql-manual/sql-functions/table-valued-functions/iceberg-meta) table function to query the snapshot information of the specified table.
